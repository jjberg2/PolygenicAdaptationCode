...
CreateTraitFile ( "Trait_Data/FilesForPaper/CD.txt" , "Genome_Data/HapMapInHGDP_PositionsAndBValues")
RemoveSNPs ( "Trait_Data/FilesForPaper/CD.txt" , "Trait_Data/FilesForPaper/CD.HapMapInHGDP_PositionsAndBValues.freqs" , "Trait_Data/FilesForPaper/newCD.txt" )	
options ( error = function () {pushover("Error");recover()})
PolygenicAdaptationFunction ( 
									gwas.data.file = "Trait_Data/FilesForPaper/newCD.txt" , 
									freqs.file = "Trait_Data/FilesForPaper/CD.HapMapInHGDP_PositionsAndBValues.freqs" , 
