...
#CreateTraitFile ( "Trait_Data/FilesForPaper/UC.txt" , "Genome_Data/HapMapInHGDP_PositionsAndBValues")
#RemoveSNPs ( "Trait_Data/FilesForPaper/UC.txt" , "Trait_Data/FilesForPaper/UC.HapMapInHGDP_PositionsAndBValues.freqs" , "Trait_Data/FilesForPaper/newUC.txt" )	
options ( error = function () {pushover("Error");recover()})
PolygenicAdaptationFunction ( 
									gwas.data.file = "Trait_Data/FilesForPaper/newUC.txt" , 
									freqs.file = "Trait_Data/FilesForPaper/UC.HapMapInHGDP_PositionsAndBValues.freqs" , 
